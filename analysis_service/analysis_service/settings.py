...
SECRET_KEY = 'django-insecure-^5jn%%u2r8%vm42-cmo$#odu!kls!!jcv^!#@+m#h59y*p7zj7'
...
SIMPLE_JWT = {
    'TOKEN_USER_CLASS': 'users.token_user.CustomizedTokenUser',
    'SIGNING_KEY': os.environ.get('JWT_SIGNING_KEY', 'default_sign_key12343#@###$D#@1'),
    'ACCESS_TOKEN_LIFETIME': timezone.timedelta(days=600),
    'REFRESH_TOKEN_LIFETIME': timezone.timedelta(days=600),
}
